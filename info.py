...
API_ID = int(environ.get('API_ID', '5927744'))
API_HASH = environ.get('API_HASH', 'd8520c2d4515a7718cc41e398ec3ae28')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1325856871').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001497551448'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001705563862').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001628145425') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1001628145425')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002621838424')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001705563862')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002799065050').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AUTOFILTR:dOeEHoF1LIBLwkYy@cluster0.fvmd3ud.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "DOWNTOWN")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'OLD DOWNTOWN')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+WecTCQF8FAEwMDJl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/D_W_T_1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+Ud1iQz3fJZFlNmE1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Zeus_bro_BP_bot')
